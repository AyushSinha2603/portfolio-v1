...
import { Code, Mail, Briefcase, ExternalLink, Activity, Database, Layout, Server, GitMerge, ChevronDown, Rocket, Map, Users, Crown, Gamepad2 } from "lucide-react";
      ...
      <main className="relative bg-black text-white w-full overflow-x-hidden font-sans">
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <section className="min-h-[70vh] flex items-center justify-center p-4 lg:p-12 xl:p-24 relative">
            ...
            >
              <motion.h2 variants={fadeUp} className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-16 text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-800 drop-shadow-2xl text-center">
                Dashboard
              </motion.h2>

              {/* Tech Stack (Wide) */}
              <motion.div variants={fadeUp} className="p-12 rounded-[3rem] border border-white/5 bg-black/60 backdrop-blur-3xl hover:border-cyan-500/30 transition-all duration-500 group relative overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Java', 'JavaScript', 'Python', 'SQL'].map(t => (
                        <span key={t} className="px-4 py-2 bg-white/5 hover:bg-white/10 transition-colors rounded-full text-xs font-bold tracking-widest border border-white/5 uppercase">{t}</span>
                      ))}
                    </div>
                  </div>
                  <div>
                    <p className="text-xs tracking-[0.2em] text-cyan-500 font-black mb-4 uppercase">Backend</p>
                    <div className="flex flex-wrap gap-2">
                      {['Spring Boot', 'Node.js', 'PostgreSQL', 'MongoDB'].map(t => (
                        <span key={t} className="px-4 py-2 bg-white/5 hover:bg-white/10 transition-colors rounded-full text-xs font-bold tracking-widest border border-white/5 uppercase">{t}</span>
                      ))}
                    </div>
                  </div>
          ...
          <section className="py-24 flex items-center justify-center relative">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="flex flex-col items-center text-center">
              ...
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-8 py-4 bg-transparent border border-white/20 text-white font-bold uppercase tracking-[0.2em] text-xs rounded-full hover:bg-white hover:text-black transition-all">

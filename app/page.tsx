      ...
      <main className="relative bg-black text-white w-full overflow-x-hidden font-sans">
        ...
        <div className="fixed inset-0 pointer-events-none flex flex-col justify-center gap-24 opacity-[0.02] z-0 overflow-hidden select-none">
          <div className="flex whitespace-nowrap animate-marquee">
            <h1 className="text-[12rem] md:text-[20rem] font-black uppercase mx-8 text-white">
              ENGINEER
            </h1>
            <h1 className="text-[12rem] md:text-[20rem] font-black uppercase mx-8 text-white">
              DESIGN
          ...
          <MorphSection>
            <section className="min-h-screen flex flex-col items-center justify-center p-8 pb-0 md:pb-8 lg:p-24 relative">
              ...
              >
                ...
                <motion.div
                  variants={fadeUp}
                  className="flex flex-col md:flex-row items-center justify-center gap-4 text-2xl md:text-4xl font-black tracking-[0.2em] uppercase mt-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-500 drop-shadow-lg"
                >
                  <span>Software Engineer</span>
                </motion.div>
                <motion.div
                  variants={fadeUp}
                  className="pt-8 text-neutral-300 font-light text-xl max-w-2xl mx-auto space-y-4 tracking-wide"
                >
                ...
                >
                  ...
                  <div className="space-y-4 md:space-y-5 text-sm md:text-base text-neutral-400 font-light leading-relaxed tracking-wide relative z-10 w-full">
                    <p className="text-lg md:text-xl font-black text-white uppercase tracking-tight leading-snug">
                      Software Engineer.
                      <br />
                      <span className="text-neutral-400 font-light text-base tracking-widest">
                        NIT Rourkela '27.
                      </span>
                    </p>
                    <div className="h-px w-16 mx-auto bg-white/10 my-3 md:my-4"></div>
                    <p className="leading-relaxed text-neutral-300">
                      What do scalable architecture, Formula 1, and chess have
                      in common?
                      <br />
                    ...
                    <p className="leading-relaxed text-neutral-300">
                      That’s exactly how I approach software engineering! I
                      don’t just build apps—I{" "}
                      <span className="text-white font-medium">
                        architect high-performance systems
                      </span>{" "}
                      designed to move fast and scale effortlessly.
                    </p>
                    <div className="h-px w-16 mx-auto bg-white/10 my-3 md:my-4"></div>
                    <p className="leading-relaxed text-neutral-300">
                      When the IDE closes... you'll find me analyzing a Grand
                      Prix, dominating the chessboard, or viewing the world
            ...
            <section className="min-h-0 md:min-h-[70vh] flex items-center justify-center py-12 md:py-24 px-6 md:p-4 lg:p-12 xl:p-24 relative">
              ...
              >
                <div className="flex justify-start md:justify-end w-full">
                  <motion.h2
                    variants={fadeUp}
                    className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-16 text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-400 md:to-neutral-800 drop-shadow-2xl text-left md:text-right"
                  >
                    Tech Stack
                  </motion.h2>
                </div>
          ...
          <MorphSection>
            <section className="min-h-0 md:min-h-[70vh] flex flex-col items-center justify-center py-12 md:py-24 px-6 md:p-4 lg:p-12 xl:p-24 relative">
              ...
              >
                <motion.h2
                  variants={fadeUp}
                  className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-16 text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-400 md:to-neutral-800 drop-shadow-2xl"
                >
                  Projects
                </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <a
                        href="https://github.com/AyushSinha2603/MailSense-AI"
                        target="_blank"
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed font-light mb-6">
                          Chess opening preparation tool serving active players
                          with real-time stats and dynamic game analysis.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-8">
                          {[
                            "Python",
                      ...
                      <a
                        href="https://github.com/AyushSinha2603/opening-forge"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative z-10 mt-auto inline-flex items-center text-sm font-black uppercase tracking-[0.2em] text-white hover:text-neutral-400 transition-colors w-max"
                      >
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed font-light mb-6">
                          Deployed site and backend architecture for an indie
                          game development studio, optimizing content delivery.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-8">
                          {[
                            "Next.js",
                      ...
                      <a
                        href="https://sleepyheadstudios.in/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative z-10 mt-auto inline-flex items-center text-sm font-black uppercase tracking-[0.2em] text-white hover:text-neutral-400 transition-colors w-max"
                      >
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed font-light mb-6">
                          A modern movie discovery app built with React,
                          Appwrite, and TMDB API for dynamic UI rendering.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-8">
                          {["React", "Tailwind", "Appwrite", "TMDB"].map(
                            (tag) => (
                              <span
                                key={tag}
                                className="text-[10px] font-black uppercase tracking-widest px-3 py-1 bg-white/5 border border-white/10 rounded-full text-neutral-300"
                      ...
                      <a
                        href="https://github.com/AyushSinha2603/cineverse"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative z-10 mt-auto inline-flex items-center text-sm font-black uppercase tracking-[0.2em] text-white hover:text-neutral-400 transition-colors w-max"
                      >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed font-light mb-4">
                          Machine learning models predicting traffic accident
                          severity based on historical geospatial data, weather,
                          and time series.
                        </p>
                      ...
                      <a
                        href="https://github.com/AyushSinha2603/Traffic-Accident-Severity-Prediction"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative z-10 mt-auto inline-flex items-center text-sm font-black uppercase tracking-[0.2em] text-white hover:text-neutral-400 transition-colors w-max"
                      >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <div>
                        ...
                        <p className="text-neutral-400 text-sm leading-relaxed font-light mb-6">
                          ...
                          of traffic flow and emission reductions during the
                          Odd-Even vehicle rationing policy implementation.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-8">
                          {["Pandas", "Matplotlib", "Seaborn", "Jupyter"].map(
                            (tag) => (
                              <span
                                key={tag}
                                className="text-[10px] font-black uppercase tracking-widest px-3 py-1 bg-white/5 border border-white/10 rounded-full text-neutral-300"
                      ...
                      <a
                        href="https://github.com/AyushSinha2603/Odd-Even-Policy"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="relative z-10 mt-auto inline-flex items-center text-sm font-black uppercase tracking-[0.2em] text-white hover:text-neutral-400 transition-colors w-max"
                      >
                    ...
                    >
                      ...
                      <div className="relative z-10 h-full flex flex-col">
                        <div>
                          ...
                          <p className="text-neutral-400 text-sm leading-relaxed font-light mb-6">
                            Improved opening classification and transposition
                            mapping for Lichess, one of the largest open-source
                            chess platforms.
                          </p>
                        </div>
                        <a
            ...
            <section className="relative flex flex-col justify-center bg-transparent pt-20 md:pt-32 pb-16 md:pb-24">
              <div className="max-w-7xl mx-auto w-full px-8 lg:px-24 relative z-10 flex flex-col items-center text-center">
                ...
                >
                  <motion.h2
                    variants={fadeUp}
                    className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter leading-none drop-shadow-2xl"
                  >
                    Got an idea? <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-500 drop-shadow-[0_0_40px_rgba(255,255,255,0.4)]">
                      Let's Talk.
                    </span>
                  </motion.h2>
                  ...
                  >
                    <button
                      ...
                      className="group relative flex items-center justify-center px-12 py-6 bg-white text-black font-black uppercase tracking-[0.3em] text-lg rounded-full overflow-hidden hover:scale-105 transition-transform shadow-[0_0_40px_rgba(255,255,255,0.4)] hover:shadow-[0_0_80px_rgba(255,255,255,0.4)] cursor-pointer outline-none border-none"
                    >
                      ...
                      <span className="relative z-10 flex items-center">
                        <Mail className="w-6 h-6 mr-4" /> Let's Collaborate
                      </span>
                    </button>
                  </motion.div>
                  ...
                  <motion.div
                    variants={fadeUp}
                    className="flex flex-col justify-center items-center gap-8 pt-12 w-full mt-16 border-t border-white/10 pb-8"
                  >
                    <div className="flex gap-8 items-center flex-wrap justify-center">
                      <a
                        href="https://github.com/AyushSinha2603"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xl md:text-2xl font-black uppercase tracking-tight hover:text-neutral-400 transition-colors drop-shadow-md"
                      >
                        GitHub
                      </a>
                      <a
                        href="https://linkedin.com/in/ayush-sinha-70046a319/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xl md:text-2xl font-black uppercase tracking-tight hover:text-neutral-400 transition-colors drop-shadow-md"
                      >
                      ...
                      <button
                        ...
                        className="text-xl md:text-2xl font-black uppercase tracking-tight hover:text-neutral-400 transition-colors drop-shadow-md cursor-pointer bg-transparent border-none outline-none"
                      >
                        Resume
                      </button>
                    </div>
          ...
          {isContactModalOpen && (
            ...
            >
              ...
              >
                <button
                  onClick={() => setIsContactModalOpen(false)}
                  className="absolute top-8 right-8 p-4 bg-white/5 hover:bg-white/20 rounded-full transition-colors text-white hover:text-neutral-400"
                >
                  <X className="w-6 h-6" />
                </button>
                <h3 className="text-4xl font-black uppercase tracking-widest text-white mb-8">
                  Send a Message
                </h3>
